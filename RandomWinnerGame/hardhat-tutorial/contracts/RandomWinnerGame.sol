...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    //Id de la llave publica con la que se genera la aleatoriedad
    ...
    //Para ver si el juego ha empezado
    ...
    //Evento emitido cuando empieza el juego
    event GameStarted(uint256 gameId, uint8 maxPlayers, uint256 entryFee);

    //Evento emitido cuando entra un jugador
    event PlayerJoined(uint256 gameId, address player);

    //Evento emitido cuando termina el juego
    ...
    function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner {
        require(!gameStarted, "Un juego esta en marcha");
